...
function getP() {
  ...
  if (!tipe) {
    document.getElementById('profilex').addEventListener('click', function() {
      liff.sendMessages([{
        type: 'template',
        altText: 'Banyumili BOTS Corp..',
        template: {
          type: 'buttons',
          thumbnailImageUrl: 'https://github.com/Banyumil1/Banyumil1.github.io/blob/main/assets/profile.png',
          imageAspectRatio: 'square',
          imageSize: 'cover',
          title: 'Theay BOTS Corp..',
          text: 'LINE Future ゲン',
          actions: [
            {
              type: 'uri',
              label: 'Owner',
              uri: 'https://line.me/ti/p/~ayank_geliecce'
            }
          ]
        }
      }]).then(function() {
    ...
    document.getElementById('textx').addEventListener('click', function() {
      liff.sendMessages([{
        ...
        sentBy: {
          label: 'D-RAINS BOTS Corp..',
          iconUrl: 'https://github.com/Banyumil1/Banyumil1.github.io/blob/main/assets/logo.gif',
          linkUrl: 'https://line.me/ti/p/~ayank_geliecce'
        }
      }]).then(function() {
        liff.closeWindow();
      });
    ...
    document.getElementById('imagex').addEventListener('click', function() {
      liff.sendMessages([{
        type: 'image',
        originalContentUrl: 'https://github.com/Banyumil1/Banyumil1.github.io/blob/main/assets/profile.png',
        previewImageUrl: 'https://github.com/Banyumil1/Banyumil1.github.io/blob/main/assets/profile.png',
        sentBy: {
          label: 'D-RAINS BOTS Corp..',
          iconUrl: 'https://github.com/Banyumil1/Banyumil1.github.io/blob/main/assets/logo.gif',
          linkUrl: 'https://line.me/ti/p/~ayank_geliecce'
...
function makeProfile() {
  ...
  liff.getProfile().then(function(prof) {
    ...
    if (pict == null) {
      var pict = 'https://github.com/Banyumil1/Banyumil1.github.io/blob/main/assets/hlth_img_not_found.jpg';
    }
